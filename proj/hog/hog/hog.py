...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return True if opponent_score - player_score < 3 and opponent_score > player_score else False
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            h = h(score0, score1)
            while extra_turn(score0, score1) and score0 < goal and score1 < goal: # when a player wins he doesn't have to take turn anymore.
                score0 += take_turn(strategy0(score0, score1), score1, dice)
                h = h(score0, score1)
        elif who == 1:
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            return announce_highest(who, score0, r)
            ...
            return announce_highest(who, score1, r)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    bacon = free_bacon(opponent_score)
    if bacon_strategy(score, opponent_score, cutoff, num_rolls) == 0 or extra_turn(score + bacon, opponent_score):
        return 0
